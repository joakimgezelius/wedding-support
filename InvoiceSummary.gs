...
function onUpdateInvoiceSummary() {
  trace("onUpdateInvoiceSummary");
  var eventDetailsIterator = new EventDetailsIterator();
  var invoiceSummaryBuilder = new InvoiceSummaryBuilder("InvoiceSummary");
  eventDetailsIterator.iterate(invoiceSummaryBuilder);
  
}

//=============================================================================================
// Class InvoiceSummaryBuilder
//
var InvoiceSummaryBuilder = function(targetRangeName) {
...
InvoiceSummaryBuilder.prototype.onBegin = function() {
...
InvoiceSummaryBuilder.prototype.onEnd = function() {
...
InvoiceSummaryBuilder.prototype.onTitle = function(row) {
  ...
  targetRow.setBackground("#b7e1cd"); // Teal
}

InvoiceSummaryBuilder.prototype.onRow = function(row) {
...
InvoiceSummaryBuilder.prototype.fillTitleSum = function(nextTitleSumCell) {
